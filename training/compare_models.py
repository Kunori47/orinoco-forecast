...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Construye tabla comparativa LSTM vs Transformer por ciudad.")
...
def build_comparison_table(df_long: pd.DataFrame) -> pd.DataFrame:
    ...
    return out.sort_values("target_col").reset_index(drop=True)
...
def main() -> None:
    ...
    df_comp = build_comparison_table(df_long)
